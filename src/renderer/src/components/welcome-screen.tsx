  ...
  return (
    <div className="bg-black min-h-screen flex flex-col items-center justify-center p-6">
      <div className="max-w-md w-full bg-black border border-white/10 rounded-xl p-6 shadow-lg">
        <h1 className="text-2xl font-bold text-white gap-2 mb-6 flex items-center">
          <span>Interview Help</span>
        </h1>
        <div className="mb-8">
          <h2 className="text-lg font-medium text-white mb-3">Welcome to Interview Help</h2>
        ...
        <div className="bg-white/5 border border-white/10 rounded-lg p-4 mb-6">
          ...
          <Button
            className="w-full px-4 py-3 cursor-pointer bg-white text-black rounded-xl font-medium hover:bg-white/90 transition-colors flex items-center justify-center gap-2"
