...
export const QueueCommand = ({
  ...
  // Helper function to generate screenshot command text
  const getScreenshotCommandText = (count: number): string => {
    if (count === 0) return 'Take first screenshot'
    if (count === 1) return 'Take second screenshot'
    if (count === 2) return 'Take third screenshot'
    if (count === 3) return 'Take fourth screenshot'
    if (count === 4) return 'Take fifth screenshot'
    return 'Next will repeat first screenshot'
  }
        ...
        <div className="text-xs backdrop-blur-md bg-black/10 rounded-lg py-2 px-4 flex justify-between items-center gap-4">
          ...
          >
            <span className="text-[11px] leading-none truncate">
              {getScreenshotCommandText(screenshotCount || 0)}
            </span>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <div
                        ...
                        onClick={async () => {
                          // TODO: Implement solve problem command
                        }}
                      >
                        <div className="flex items-center justify-between">
