...
const Solutions = ({ setView, currentLanguage, setLanguage }: SolutionsProps) => {
    ...
    const cleanupFunctions = [
      ...
      window.electronAPI.onDebugError(() => {
        toast.error('Processing Failed', {
          description: 'There was an error debugging your solution'
        })
        setDebugProcessing(false)
      }),
      window.electronAPI.onProcessingNoScreenshots(() => {
        toast.info('No Screenshots', {
          description: 'There are no extra screenshots to debug'
        })
      }),
